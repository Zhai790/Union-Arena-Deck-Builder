...
import { parseTextDeck } from '../lib/storage/text-deck-parser';
...
export function DeckInput() {
  ...
  const handleImport = () => {
    try {
      const deck = parseTextDeck(deckInput);
      setCurrentDeck(deck);
      setError(null);
  ...
  return (
    <div style={{ marginBottom: '2rem' }}>
      ...
      <p style={{ color: '#666', marginBottom: '0.5rem' }}>
        Paste your deck below in text format (e.g., "4 x TKG-1-080")
      </p>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <p style={{ fontSize: '12px', fontWeight: 'bold', marginBottom: '0.5rem' }}>Example:</p>
        <pre
          style={{
            background: '#f5f5f5',
            padding: '0.75rem',
      ...
      <textarea
        ...
        placeholder="Paste deck here (text format)..."
        style={{
          width: '100%',
          minHeight: '200px',
          padding: '1rem',
